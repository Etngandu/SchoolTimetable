...
{
    /// <inheritdoc />
    public partial class Rboot : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectDescription = table.Column<string>(type: "nvarchar(350)", maxLength: 350, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefClassR = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_classRs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_classRs_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_classRs_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                name: "PlannedTimetable",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SujectId = table.Column<int>(type: "int", nullable: false),
                    SubjectId = table.Column<int>(type: "int", nullable: true),
                    ClassRId = table.Column<int>(type: "int", nullable: false),
                    Period_Number = table.Column<int>(type: "int", nullable: false),
                    Day_Name = table.Column<int>(type: "int", nullable: false),
                    OtherDetails = table.Column<string>(type: "nvarchar(350)", maxLength: 350, nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlannedTimetable", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlannedTimetable_classRs_ClassRId",
                        column: x => x.ClassRId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_classRs_SubjectId",
                table: "classRs",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_classRs_TeacherId",
                table: "classRs",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_PlannedTimetable_ClassRId",
                table: "PlannedTimetable",
                column: "ClassRId");

            migrationBuilder.CreateIndex(
                name: "IX_PlannedTimetable_SubjectId",
                table: "PlannedTimetable",
                column: "SubjectId");
